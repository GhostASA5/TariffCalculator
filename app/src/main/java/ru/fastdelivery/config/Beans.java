...
public class Beans {
    ...
    @Bean
    public TariffCalculateUseCase tariffCalculateUseCase(WeightPriceProvider weightPriceProvider, VolumePriceProvider volumePriceProvider, CoordinatesProvider coordinatesProvider) {
        return new TariffCalculateUseCase(weightPriceProvider, volumePriceProvider, coordinatesProvider);
    }
